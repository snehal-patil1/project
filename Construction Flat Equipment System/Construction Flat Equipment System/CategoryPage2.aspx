                                    ...
                                    <div class="top-banner-wrapper">
                                        <div class="top-banner-content small-section">
                                           <h4>Product Category</h4>
                                            <h5>Flat</h5>
                                            <p>A Flat is any material of natural or synthetic origin that is applied to soil or to plant tissues to supply plant nutrients. Flats may be distinct from liming materials or other non-nutrient soil amendments. Many sources of Flat exist, both natural and industrially produced.For most modern agricultural practices, fertilization focuses on three main macro nutrients: nitrogen (N), phosphorus (P), and potassium (K) with occasional addition of supplements like rock flour for micronutrients.</p>
                                        </div>
                                    </div>
                                    <div class="collection-product-wrapper">
                                        <div class="product-top-filter">
